...
public record Route(List<Vertex> route, Set<Sight> sights, double routeDistance) {

    public Route(List<Vertex> route, double routeDistance) {
        this(route, Collections.emptySet(), routeDistance);
    }
